...
describe("API pública de tablas", () => {
  ...
  it("exporta el layout integrado y el administrador SPA", () => {
    ...
    expect(createNRouteSearchHook).toBeTypeOf("function")
    expect(useNRouteSearch).toBeTypeOf("function")
    expect(numberParam).toBeTypeOf("function")
    expect(stringParam).toBeTypeOf("function")
