...
import type { NauthOtpVerificationProps } from "./types"
...
export function NauthOtpVerification({ length = 6, value, defaultValue = "", maskedDestination, resendSeconds = 0, autoFocus = true, onValueChange, onComplete, onSubmit, onResend, title, subtitle, labels: labelsProp, loading = false, disabled = false, error, success, colorPalette = "blue", classNames, styles }: NauthOtpVerificationProps) {
...
/** @deprecated Usa `NauthOtpVerification`. */
export const NOtpVerification = NauthOtpVerification
