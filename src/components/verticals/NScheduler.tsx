...
export function NScheduler({ events, startDate = new Date(), days = 7, onEventSelect, labels: custom, unstyled = false, classNames, styles }: NSchedulerProps) {
