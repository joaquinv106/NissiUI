...
const publicNames = ["NThemeProvider", "NAmountInput", "NCheckout", "NPanel", "NThermalPrint", "NloginPage", "NauthLogin", "Nlayout", "Nroutes", "NRouteOutlet", "NOutlet", "NLink", "useNLocation", "useNNavigate", "useNTypedNroutes", "useNRouteSearch", "defineNRouteSearch", "createNRouteSearchHook", "numberParam", "stringParam", "createNRouteTransition", "createNRouteCacheKey", "resolveNRouteTarget", "NRouteCache", "NRouteModuleRegistry"]
...
try {
  ...
  writeFileSync(
    ...
    'import { NThermalPrint } from "nissi-ui/thermal-print"\nimport { NPanel } from "nissi-ui/panel"\nimport { NloginPage, NauthLogin } from "nissi-ui/auth"\nimport { Nlayout } from "nissi-ui/layout"\nimport { Nroutes, NLink, NOutlet, useNTypedNroutes, useNRouteSearch, defineNRouteSearch, createNRouteSearchHook, numberParam, stringParam, createNRouteTransition, createNRouteCacheKey, resolveNRouteTarget, NRouteCache, NRouteModuleRegistry } from "nissi-ui/routes"\nvoid [NThermalPrint, NPanel, NloginPage, NauthLogin, Nlayout, Nroutes, NLink, NOutlet, useNTypedNroutes, useNRouteSearch, defineNRouteSearch, createNRouteSearchHook, numberParam, stringParam, createNRouteTransition, createNRouteCacheKey, resolveNRouteTarget, NRouteCache, NRouteModuleRegistry]\n',
  )
