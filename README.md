...
- `Nroutes`: router SPA progresivo con location completa, rutas anidadas, branch diff, loaders paralelos, caché SWR/GC, módulos lazy, routing tipado opt-in por id/params/search, boundaries, `NLink`, prefetch y adaptadores externos.
