...
| `Nlayout` / `Nroutes` | Plataforma SPA · v3 Fases 1–7 | [Layout y rutas](./layout-routes.md), [arquitectura](./nroutes-architecture.md), [lifecycle](./nroutes-navigation-lifecycle.md), [caché](./nroutes-cache.md), [módulos lazy](./nroutes-route-modules.md), [routing tipado](./nroutes-typed-routing.md), [search tipado](./nroutes-search.md), [blockers](./nroutes-blockers.md) | `src/components/layout/Nlayout.test.tsx`, `src/components/routes/Nroutes.test.tsx`, `src/components/routes/search.test.tsx`, `src/components/routes/blockers.test.tsx` |
